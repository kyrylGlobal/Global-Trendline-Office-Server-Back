            ...
            countryElement.names.forEach(countryName => {
                if (countryName === invoiceObject.KRAJ.cdata) {
                    if (pozycje.POZYCJA) { // optimise
                        let vatCheckResult = countryElement.viesConfig ? (0, jsvat_1.checkVAT)(`${countryElement.shortName}${invoiceObject.NIP.cdata}`, [countryElement.viesConfig]) : null;
...
function updateFinishedJObject(invoiceObject) {
    ...
    if (((_a = invoiceObject.NR_KSEF) === null || _a === void 0 ? void 0 : _a.cdata) !== undefined)
        invoiceObject.NR_KSEF = invoiceObject.NR_KSEF.cdata;
    if (((_b = invoiceObject.DODATKOWY_OPIS) === null || _b === void 0 ? void 0 : _b.cdata) !== undefined)
        invoiceObject.DODATKOWY_OPIS = invoiceObject.DODATKOWY_OPIS.cdata;
}
