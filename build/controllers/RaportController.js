            ...
            if (!req.files) {
                ...
                try {
                    if (Array.isArray(req.files.raport)) {
                        ...
                        const useNewVersion = JSON.parse(req.body.useNewVersion);
                        const xmlResultData = yield RaportService_1.default.generateXmlResultFileData(raportFile, useNewVersion);
                    ...
                    next(new Error(error === null || error === void 0 ? void 0 : error.message));
                }
            }
        });
    }
