...
exports.setLastGoogleSheetRowNumber = exports.getLastGoogleSheetRowNumber = exports.createValues = exports.getSattisticsByName = exports.addOrdersToBaselinker = exports.parseWoocomersJsonOrdersToBaselinker = exports.combineStatuseByCountry = exports.filterStatusesByName = void 0;
...
function addOrdersToBaselinker() {
    return __awaiter(this, void 0, void 0, function* () {
        const baselinkerApiController = new BaselinkerApiController_1.default();
        ...
        const woocomerceOrders = JSON.parse(Files_1.default.readFileSync(fileWithWoocomerceJsonData));
        let parsedBaselinkerOrders = parseWoocomersJsonOrdersToBaselinker(woocomerceOrders, yield (baselinkerApiController.getOrderStatusIdByName(baselinkerStatusForAdding)));
        const baselinkerOrdersFromFolder = yield baselinkerApiController.getOrders({
            statusId: yield (baselinkerApiController.getOrderStatusIdByName(baselinkerStatusForChecking))
        });
        parsedBaselinkerOrders = parsedBaselinkerOrders.filter(order => {
            var _a;
            for (let folderOrders of baselinkerOrdersFromFolder) {
                if (folderOrders.shop_order_id.toString() === ((_a = order.custom_source_id) === null || _a === void 0 ? void 0 : _a.toString())) {
                    return false;
                }
            }
            return true;
...
exports.addOrdersToBaselinker = addOrdersToBaselinker;
function getSattisticsByName(orders, productSkus) {
    let statistic = {};
    let config = [
        {
